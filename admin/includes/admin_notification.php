...
?>
<?php
// counting unapproved messages
$testimony_query = "SELECT * FROM testimony WHERE status = 'Pending' ";
$find_count = mysqli_query($connection, $testimony_query);
$count_testimony = mysqli_num_rows($find_count);
?>
...
<li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i> <b
    ...
    <ul class="dropdown-menu alert-dropdown">
        ...
        if ($count_dpost !== 0 || $count_upcomments !== 0 || $count_reply !== 0 || $count_inbox !== 0 || $count_testimony !== 0) {
            if ($count_dpost !== 0) {
            ...
            if ($count_testimony !== 0) {
                echo "<li> <a href='inbox.php'><span class='label label-info'>Unapproved Testimony: <b class='pull-right'><span class='badge'> $count_testimony</span></b></span></a></li>";
            }
        } else {
